...
const APPROVED_UNITS = [
  ...
  new ApprovedUnit('litre', 'L', 'volume', new Decimal(0.001), [ meter, meter, meter ], ['liter']),
...
const unitDefinitions = buildMap(BASE_UNITS.concat(APPROVED_UNITS), getSpellings);
module.exports = { APPROVED_UNITS, BASE_UNITS, unitDefinitions };
